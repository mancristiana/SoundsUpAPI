define({ "api": [
  {
    ...
    "group": "Hello",
    "version": "1.0.0",
    "description": "<p>This endpoint returns a GeoIp object containing the country name and code determined from the IP Address of the client.</p>",
    "success": {
      "examples": [
        {
    ...
    "filename": "src/main/java/dk/kea/soundsup/resources/HelloResource.java",
    "groupTitle": "Hello"
  },
  {
    "type": "get",
    ...
    "group": "Hello",
    "version": "1.0.0",
    "description": "<p>This request returns a plain text hello message. This endpoint is useful for verifying that the API works.</p>",
    "success": {
      "examples": [
        {
          "title": "SuccessResponse",
  ...
  },
  {
    ...
    "filename": "src/main/java/dk/kea/soundsup/resources/PostResource.java",
    "groupTitle": "Posts"
  },
  {
    "type": "delete",
  ...
  },
  {
    ...
    "group": "Spotify",
    "version": "1.0.0",
    "description": "<p>This request returns a token needed during the client credentials flow to access resources from the Spotify Web API.</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "idToken",
            "description": "<p>token allowing you to make requests to the Spotify Web API endpoints that do not require user authorization. For example, Get a track endpoint.</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "src/main/java/dk/kea/soundsup/resources/SpotifyResource.java",
    "groupTitle": "Spotify"
  },
  {
    "type": "get",
    ...
    "filename": "src/main/java/dk/kea/soundsup/resources/UserResource.java",
    "groupTitle": "User"
  },
  {
    "type": "get",
